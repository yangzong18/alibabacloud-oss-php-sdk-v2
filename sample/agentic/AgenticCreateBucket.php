...
// because the agentic client resolves the logical bucket name to its physical form.
...
try {
    $request = new Models\CreateAgenticBucketRequest(
        $bucket,
        new Models\CreateAgenticBucketConfiguration('Standard', 'LRS')
    );
    $result = $client->createAgenticBucket($request);
