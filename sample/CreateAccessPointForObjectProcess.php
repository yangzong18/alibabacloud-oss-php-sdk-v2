...
$request = new Oss\Models\CreateAccessPointForObjectProcessRequest($bucket, $objectProcessName);
$request->createAccessPointForObjectProcessConfiguration = new Oss\Models\CreateAccessPointForObjectProcessConfiguration(
...
$result = $client->createAccessPointForObjectProcess($request);
